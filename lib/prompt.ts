...
- Source tags stay in square brackets exactly as written ([NSCA], [KOOP], [JUDGMENT]...) - the app renders them as tappable info buttons. Do not expand source names inline.
